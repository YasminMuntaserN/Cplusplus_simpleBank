...
namespace Karate_DataAccsess
{
    public class clsSubscriptionPeriodsData
    {
        ...
        public static bool ExistWithMemberID(int? MemberID)
        {
            return clsDataAccessHelper.Exists("select isFound =1 from SubscriptionPeriods where MemberID =@MemberID", "MemberID", MemberID);
        }
