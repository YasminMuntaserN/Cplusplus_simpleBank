...
namespace KarateClub__Project_3_.MemberInstructors
{
    public partial class frmMemberInstructorsList : Form
    {
        ...
        private void frmMemberInstructorsList_Load(object sender, EventArgs e)
        {
            ...
            {
                dgvMemberInstractors.Columns[0].Width = 140;

                dgvMemberInstractors.Columns[1].Width = 160;

                dgvMemberInstractors.Columns[2].Width = 160;

                dgvMemberInstractors.Columns[3].Width = 160;
        ...
        private void dgvMemberInstractors_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            cmsshowMembersInstructorsDetailsToolStripMenuItem.PerformClick();
        }
    }
}
