...
namespace KarateClub__Project_3_.Instructors
{
    public partial class ctrlInstructorCardWithFilter : UserControl
    {
        ...
        public void LoadPersonInfo(int? PersonID)
        {
            ...
            ctrlInstructorCard1.LoadInstructorInfoByPersonID(_Instructor.InstructorID);
            _Instructor = ctrlInstructorCard1.SelectedInstructorInfo;
            if (_Instructor != null)
            {
                _InstructorID = _Instructor.InstructorID;
        ...
        private void FindNow()
        {
            ...
            switch (cbFindBy.Text.Trim())
            {
                case "Person ID":
                    ...
                    ctrlInstructorCard1.LoadInstructorInfoByPersonID(int.Parse(txtFilterValue.Text));
                    break;
                ...
                case "Instructor ID":
                    ...
                    ctrlInstructorCard1.LoadInstructorInfo(int.Parse(txtFilterValue.Text));
                    break;
            ...
            if (OnInstructorSelectedEvent != null)
                OnInstructorSelected(_Instructor.InstructorID);
        }
