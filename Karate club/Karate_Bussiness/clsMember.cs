...
namespace Karate_Bussiness
{
    public class clsMember : clsPeople
    {
        ...
        public bool HasMemberSubscriptionPeriod => clsSubscriptionPeriod.ExistByMemberID(MemberID);

        public clsBeltRank NextBeltRank => clsBeltRank.NextBeltRankInfo(LastBeltRankID);

        public bool DidPassPreviousTest => clsBeltTest.PassTest(LastBeltRankID);
