...
namespace Karate_Bussiness
{
    public class clsPayments
    {
        ...
        public static clsPayments PayForSubscriptionPeriod(clsSubscriptionPeriod period)
        {
            clsPayments payment = new clsPayments();
            payment.Amount = period.MemberInfo.LastBeltRankInfo.TestFees;
            payment.MemberID = period.MemberID;
            payment.Date = DateTime.Now;
            return payment;
        }

        public static int? PayForTest(clsMember member)
        {
            clsPayments payment = new clsPayments();
